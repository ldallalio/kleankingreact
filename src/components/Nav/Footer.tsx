			...
			<div className="footerTopSection">
				...
				<div className="footerLogoArea">
					...
					<div className="footerLogoText">
						At Klean King Air Duct Cleaning and Restoration, we strive to
						...
						<div className="fb">
							...
							<a href="#" className="insta">
								<svg
									...
									xmlns="http://www.w3.org/2000/svg"
								>
									<circle cx="24" cy="24" r="24" fill="#C52026" />
									<g clip-path="url(#clip0_12_302)">
										...
										/>
										<path
											d="M24 17.8403C20.6 17.8403 17.84 20.6003 17.84 24.0003C17.84 27.4003 20.6 30.1603 24 30.1603C27.4 30.1603 30.16 27.4003 30.16 24.0003C30.16 20.6003 27.4 17.8403 24 17.8403ZM24 28.0003C21.8 28.0003 20 26.2003 20 24.0003C20 21.8003 21.8 20.0003 24 20.0003C26.2 20.0003 28 21.8003 28 24.0003C28 26.2003 26.2 28.0003 24 28.0003Z"
											fill="white"
										/>
										<path
											d="M31.84 17.5997C31.84 18.3997 31.2 19.0397 30.4 19.0397C29.6 19.0397 28.96 18.3997 28.96 17.5997C28.96 16.7997 29.6 16.1597 30.4 16.1597C31.2 16.1597 31.84 16.7997 31.84 17.5997Z"
											fill="white"
										/>
									</g>
									<defs>
				...
				<div className="footerLinks">
						...
						<div className="footerLink">
							...
							>
								<g clip-path="url(#clip0_12_276)">
									<path
										d="M21.8908 2.85938H2.10951C1.78481 2.85938 1.48083 2.9392 1.20581 3.07078L11.9533 13.8182L14.3621 11.5032C14.3621 11.5032 14.3623 11.503 14.3624 11.5029C14.3624 11.5028 14.3626 11.5027 14.3626 11.5027L22.7948 3.07097C22.5197 2.9393 22.2156 2.85938 21.8908 2.85938Z"
										fill="#C52026"
									/>
									<path
					...
					>
						...
						<div className="footerLink">Monroe, LA</div>
						<div className="footerLink">West Monroe, LA</div>
						<div className="footerLink">Ruston, LA</div>
						<div className="footerLink">Farmerville, LA</div>
						<div className="footerLink">Bastrop, LA</div>
						<div className="footerLink">Rayville, LA</div>
						<div className="footerLink">Columbia, LA</div>
						<div className="footerLink">Winnsboro, LA</div>
						<div className="footerLink">Sterlington, LA</div>
					</div>
				</div>
			</div>
			{/* Section 3 */}
