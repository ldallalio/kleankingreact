		...
		<div className='footerContainer'>
			<div className='footerTopSection'>
				...
				<div className='footerLinks'>
					...
					{/* <div className='subscribeCol'>
						<div className='footerLinksHeader'>Subscribe to Our Newsletter</div>
						<div className='footerLink'>Link 1</div>
						<div className='footerLink'>Link 2</div>
					</div> */}
				</div>
			</div>
			{/* Section 3 */}
